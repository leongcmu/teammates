  ...
  private getTableData(): void {
    ...
    this.perRecipientRowsData = Object.keys(this.perRecipientResponses).map((key: string) => {
      ...
      return [
        ...
        {
          value:
            this.perRecipientResponses[key].total === null
              ? '-'
              : (this.perRecipientResponses[key].total).toFixed(2),
        },
        {
          value:
            this.perRecipientResponses[key].average === null
            ? '-'
            : (this.perRecipientResponses[key].average).toFixed(2),
        },
      ];
    });
  }
